...
<html>
    ...
    <body>
        ...
        <form method="POST" action="http://localhost:8084/coursework/do/addUser">
            ...
            Username:<input type="text" name="newUsername" id= "new" value="" onkeyup= "check()"/>----
            Password:<input type="password" name="newPassword" value=""/>      
            <input type="submit" value="Sign up as a new user" id= "register" disabled/>
        </form>
        ...
        <script>
            ...
            function check(){
                ...
                var username = document.getElementById("new");
                
                //checks if the lengh of the username is less than 7
